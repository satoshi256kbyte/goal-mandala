...
interface TaskListPageProps {
  ...
  onSaveView: (name: string, filters: TaskFilters, searchQuery: string) => void;
}
...
export const TaskListPage: React.FC<TaskListPageProps> = ({
  ...
  const handleBulkAction = (action: 'complete' | 'delete') => {
    ...
    if (action === 'complete') {
      onBulkStatusChange(selectedTasks, 'completed');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-6">
            <TaskSearch
              ...
              onSaveView={name => onSaveView(name, filters, searchQuery)}
            />
