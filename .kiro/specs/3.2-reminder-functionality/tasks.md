...
- [ ] 4. Email Service実装
  - [ ] 4.1 Email Serviceの実装
    - [ ] 4.1.1 メールテンプレートエンジンの実装
      - Handlebarsテンプレートの作成
      - テンプレートコンパイル機能
    ...
    - [ ]* 4.1.5 Email Serviceのユニットテスト
      - メールテンプレート生成のテスト
      - Deep Link生成のテスト
      - SES統合のテスト（モック）
      - リトライロジックのテスト
      - _Requirements: 1.4, 2.1-2.4, 3.1, 9.1_
    - [ ]* 4.1.6 Email Serviceのプロパティテスト
...
- [ ] 5. Reminder Lambda Function実装
  - [ ] 5.1 Reminder Lambda Functionの実装
    - [ ] 5.1.1 メインハンドラーの実装
      - EventBridgeイベントの受信
      - 全ユーザーの処理オーケストレーション
      - バッチ処理（100ユーザーずつ）
    ...
    - [ ]* 5.1.5 Reminder Lambda Functionのユニットテスト
      - メインハンドラーのテスト
      - ユーザー処理ロジックのテスト
      - エラーハンドリングのテスト
      - ログ記録のテスト
      - _Requirements: 1.1-1.5, 6.1, 6.4, 7.1-7.5, 8.1-8.4_
    - [ ]* 5.1.6 Reminder Lambda Functionのプロパティテスト
...
- [ ] 6. Unsubscribe機能実装
  - [ ] 6.1 Unsubscribe Handlerの実装
    - [ ] 6.1.1 配信停止エンドポイントの実装
      - GET /api/reminders/unsubscribe/:token
      - トークン検証
      - ユーザー設定の更新
      - _Requirements: 9.2_
    - [ ] 6.1.2 再有効化エンドポイントの実装
      - POST /api/reminders/enable
      - ユーザー設定の更新
      - _Requirements: 9.4, 9.5_
    - [ ]* 6.1.3 Unsubscribe Handlerのユニットテスト
      - 配信停止のテスト
      - 再有効化のテスト
      - トークン検証のテスト
      - _Requirements: 9.2, 9.4, 9.5_
    - [ ]* 6.1.4 Unsubscribe機能のプロパティテスト
