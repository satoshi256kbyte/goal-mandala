...
### 未完了
- Lambda Handlerの完全実装とテスト
- フロントエンドページコンポーネントの完全実装
...
- [ ] 3. フロントエンド実装
  ...
  - [ ] 3.4 TaskDetailPageの実装
    ...
    - [ ] 3.4.2 TaskDetailPageのユニットテスト
      - タスク詳細の表示テスト
      - 状態更新のテスト
      - ノート機能のテスト
      - 履歴表示のテスト
      - _Requirements: 2.1-2.5, 3.1-3.5, 13.1-13.5_
    - [ ] 3.4.3 タスク状態更新のプロパティテスト
