...
- テスト修正・品質向上: 🚧 進行中（約74%完了）
  ...
  - 2.4.6 テストパフォーマンス改善: 🚧 進行中（Spec: test-performance-improvement、約14%完了）
    - タスク1: Vitest設定の最適化 ✅ 完了（4/4サブタスク）
    - タスク2: テストセットアップファイルの改善 未着手（0/2サブタスク）
    - タスク3: package.jsonスクリプトの改善 未着手（0/2サブタスク）
    - タスク4: test-with-timeout.shスクリプトの改善 未着手（0/2サブタスク）
    - タスク5: 統合テストの分離 未着手（0/2サブタスク）
    - タスク6: 動作確認とパフォーマンス測定 未着手（0/6サブタスク）
    - タスク7: ドキュメント更新 未着手（0/3サブタスク）
...
- [-] 2.4.6 テストパフォーマンス改善 (Spec: test-performance-improvement) 🚧
  - [x] 2.4.6.1 Vitest設定の最適化（完了、4/4サブタスク完了）
  - [-] 2.4.6.2 テストセットアップファイルの改善（進行中、0/2サブタスク）
  - [ ] 2.4.6.3 package.jsonスクリプトの改善
  - [ ] 2.4.6.4 test-with-timeout.shスクリプトの改善
  - [ ] 2.4.6.5 統合テストの分離
  - [ ] 2.4.6.6 動作確認とパフォーマンス測定
  - [ ] 2.4.6.7 ドキュメント更新
  - _推定工数: 3人日_
  - _優先度: 高（テスト実行時間を60秒以内に短縮）_
  - _進捗: タスク1完了、タスク2進行中、約14%完了_
